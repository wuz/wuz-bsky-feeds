...
let
  ...
  yarnBin = fetchurl {
    ...
    hash = "sha512-9Fq2MkOaZ/i8dZvzLq0Dah9BMoe5BCcmt8xIGLe0nhTpQjukmxj54G6klBwa0GI4Wx2HYKjVCRoaMeX2IZr8qA==";
  };
  ...
  cacheDrv = stdenv.mkDerivation {
    ...
    outputHash = "sha512-24xSVBqRWjzDokfBgZMKv0fuYOrkgLXIoiet5XLHlZzNsSDexpDiyiGEQahU18OqN/rP+9RuKQIVMat8POkZHA==";
  };
